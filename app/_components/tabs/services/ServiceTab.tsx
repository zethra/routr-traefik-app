...
export function ServiceTab({
  ...
  return (
    <>
    <div className="flex flex-col overflow-hidden pb-20" style={{ height: 'calc(100vh - 80px)' }}>
      ...
      <div className="flex-1 min-h-0 overflow-hidden rounded-2xl border border-border/70">
